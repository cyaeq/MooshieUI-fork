      ...
      {:else if config}
        ...
        <section data-settings-section="about" class="bg-neutral-900 rounded-xl border border-neutral-800 overflow-hidden break-inside-avoid mb-4">
          ...
          <div class="px-5 pb-5 space-y-4">
            ...
            <div role="alert" class="flex items-start gap-3 rounded-xl border border-amber-500/60 bg-amber-500/10 px-3 py-3 shadow-[0_0_20px_rgba(245,158,11,0.08)]">
              ...
              <p class="text-sm font-medium leading-relaxed text-amber-100">{locale.t('settings.about.fork_notice')}</p>
            </div>
