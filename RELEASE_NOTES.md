...
- **Parameter presets**: save and reuse generation parameter combinations from the generation interface.
- **Prompt favourites**: manage reusable prompt favourites with persistent SQLite storage.
- **Mobile gallery metadata**: inspect expanded generation metadata in the mobile lightbox, with stable logical ordering.
- **MooshieUI F branding**: refreshed product branding and localized labels across the interface.
...
- **Settings navigation improvements**: added responsive settings navigation, sidebar icons, scrolling fixes, and consistent localized labels.
- **i18n coverage**: added translations for memory modes, system RAM monitoring, desktop sidebar controls, sync navigation, gallery board deletion, parameter presets, prompt favourites, and expanded gallery metadata across all 12 supported languages.
