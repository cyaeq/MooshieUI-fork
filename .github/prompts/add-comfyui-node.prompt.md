...
description: Add a custom ComfyUI Python node with Rust registration and workflow hookup
argument-hint: "Describe the node: name, inputs, what it does to the image, and where it hooks into the workflow"
agent: agent
---
